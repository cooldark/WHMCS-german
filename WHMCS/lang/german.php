...
$_LANG["affiliatesbullet2"] = "von jeder Zahlung der Kunden, die Sie vermittelt haben. Dies gilt für die gesamte Dauer des";
$_LANG["affiliatescommission"] = "Kommission";
$_LANG["affiliatesdescription"] = "";
...
$_LANG["affiliatesfootertext"] = "Wenn Sie jemanden mit Ihrer einzigartigen Vermittlungs-ID an unsere Webseite weiterleiten, wird auf diesem Computer ein Cookie mit der Vermittlungs-ID abgelegt. Wenn dieser Besucher später zurückkehrt und eine Dienstleistung bucht erhalten Sie";
...
$_LANG["affiliatesrequestwithdrawal"] = "Überweis";
...
$_LANG["affiliateswithdrawalrequestsuccessful"] = "Ihr Überweisungsauftrag wurde übermittelt. S";
$_LANG["affiliateswithdrawn"] = "Insgesamt abgehobener Betrag";
$_LANG["all"] = "Alle";
$_LANG["alreadyregistered"] = "Sind Sie bereits Kunde?";
$_LANG["announcementsdescription"] = "Sehen Sie unsere neuesten Nachrichten & Ankündigungen";
$_LANG["announcementsnone"] = "Keine Ankündigungen zum Anzeigen";
...
$_LANG["cartcustomfieldsdesc"] = "";
$_LANG["cartdomainsconfig"] = "Domainkonfiguration";
$_LANG["cartdomainsconfigdesc"] = "Hier können Sie ihre Domainkonfiguration vornehmen, Erweiterungen hinzufügen und b";
...
$_LANG["cartnameserversdesc"] = "Wenn Sie eigene Nameserver benutzen möchten geben Sie diese bitte hier an. Standardmäßig stel";
...
$_LANG["cartproductdesc"] = "Hier sehen Sie die von Ihnen gewählten Produkte";
$_LANG["cartproductdomain"] = "Domains";
$_LANG["cartproductdomainchoose"] = "";
$_LANG["cartproductdomaindesc"] = "Das von Ihnen gewählte Produkt erfordert die Registrierung eines Domainnamens. Bitte";
...
$_LANG["carttaxupdateselections"] = "MwSt. wird abhängig vom Land berechnet. Bitte hier zur Neuberech";
$_LANG["carttaxupdateselectionsupdate"] = "Aktualisieren";
$_LANG["carttitle"] = "Mein Warenkorb";
$_LANG["changessavedsuccessfully"] = "Änderungen erfolgreich ge";
$_LANG["checkavailability"] = "";
$_LANG["checkout"] = "zur Kasse";
$_LANG["choosecurrency"] = "Währ";
$_LANG["choosedomains"] = "";
...
$_LANG["clientareaaddfundsnotallowed"] = "Sie benötigen mindestens eine aktive Bestellung um ein Guthabe";
$_LANG["clientareaaddon"] = "Zusatzpaket";
$_LANG["clientareaaddonorderconfirmation"] = "Vielen Dank. Das untenstehende Zusatzpaket wurde zur Bestellung hinzugefügt. Bitte wählen Sie n";
...
$_LANG["clientareacancelconfirmation"] = "Vielen Dank. Der Stornierungsauftrag wurde übermittelt. Falls Sie diesen Auftrag aus Versehen geschickt haben, senden Sie uns bitte umgehend ein Supportticket, bevor wir Ihren";
...
$_LANG["clientareacancelreason"] = "Grund für di";
...
$_LANG["clientareacontactsemailsdomain"] = "Domain-Email - Erneuerungshinweise, Registrierungsbestä";
...
$_LANG["clientareadescription"] = "Klicken Sie hier um Ihr Profil zu ändern, Rechnungsinformationen anzuzeigen und zusätzliche Dien";
...
$_LANG["clientareaemailsintrotext"] = "Unten finden Sie den Verlauf aller Nachrichten, die wir an Sie geschickt haben. Sie können bequem die gesamte Korrespondenz anzeigen, falls Sie unsere Emails nicht mehr z";
...
$_LANG["clientareaerrorcountry"] = "Bitte wählen Sie Ihr Land aus der";
...
$_LANG["clientareaerroroccured"] = "";
$_LANG["clientareaerrorpasswordconfirm"] = "";
$_LANG["clientareaerrorpasswordnotmatch"] = "Die Passwortbestätigung ist nicht gleich wi";
...
$_LANG["clientareaheader"] = "Willkommen in unserem Kundencenter. Hier können Sie Ihre persönlichen Daten anzeigen und aktualisieren, Ihre Hostingaccounts und Domains anzeigen, Supportanfragen absenden und zusätzliche P";
...
$_LANG["clientareasavechanges"] = "Änderun";
$_LANG["clientareasecurityanswer"] = "Bitte geben Sie eine Antwort ein";
$_LANG["clientareasecurityconfanswer"] = "Bitte bestätigen Si";
$_LANG["clientareasecurityquestion"] = "Bitte wählen Sie eine Sich";
...
$_LANG["clientareaviewaddons"] = "Mögliche Zusatzpakete / Opti";
$_LANG["clientareaviewdetails"] = "Einzelheiten anzeigen";
$_LANG["clientlogin"] = "Kundenlogin";
$_LANG["clientregisterheadertext"] = "Um ein neues Konto zu eröffnen füllen Sie bitte nachstehendes Formular aus. Die be";
...
$_LANG["contactheader"] = "Um uns zu kontaktieren füllen Sie bitte nachstehende";
...
$_LANG["creditcard3dsecure"] = "Als Teil unserer Sicherheitsvorkehrungen gegen Mißbrauch werden Sie nun gebeten, Ihre 'Verified by Visa' oder 'Mastercard SecureCode' Identifikation durchzuführen, sofern Sie fü";
...
$_LANG["creditcardconfirmation"] = "Vielen Dank! Ihre Kreditkartenzahlung wurde akzeptiert und Ihre Karte mit dem Betrag belastet. Sie erhalten in Kürze eine B";
...
$_LANG["creditcardinvalid"] = "Die angegebene Kreditkarte wurde vom Finanzinstitut als ungültig abgewiesen. Bitte versuchen Sie eine andere Kreditkarte oder kontakt";
...
$_LANG["domainbulksearchintro"] = "Mit der 'Erweiterten Domainsuche' können Sie bis zu 20 Domains auf einmal abfragen.  Geben Sie in nachstehendes Formular die Domains ein, eine per Zeile, ohne 'www.' oder 'http://' , aber bitte inklusive der Domain";
$_LANG["domainbulktransferdescription"] = "Sie können heute noch Ihre bestehenden Domains zu uns transferieren. Um zu beginnen geben Sie bitte die Domains, eine per Zeile, in das folgende Feld ein, ohne 'www.' od";
...
$_LANG["domaindnsmanagementdesc"] = "Leiten Sie Ihre Domain auf eine Webseite weiter, indem Sie auf die IP-Adresse verweisen, oder leiten Sie sie auf eine andere Seite weiter, oder leiten Sie sie auf eine temporäre Seite weiter (bekannt als 'Domain Parking'), und mehr. Diese Einträge sind auch";
$_LANG["domaindnsrecordtype"] = "Registrierungstyp";
$_LANG["domainemailforwarding"] = "Email-Weiterleitung";
$_LANG["domainemailforwardingdesc"] = "Wenn der weiterleitende Emailserver feststellt, dass die anzusprechende Emailadresse ungültig ist, so werden wir den Weiterleitungseintrag automatisch deaktivieren. Bitte prüfen Sie die Emailadresse, auf die weitergeleitet werden soll, bevor Sie sie wieder aktivieren. Die Änderungen an bestehenden Weiterleitungseinträge";
...
$_LANG["domaineppcodedesc"] = "Wir benötigen zum Providerwechsel einen sogenannten Authcode. Diesen erhalten Sie von Ihrem al";
$_LANG["domaineppcoderequired"] = "Bitte geben Sie den EPP/Authcode ein.";
$_LANG["domainerror"] = "Bei der Anfrage gab es einen Fehler:";
$_LANG["domainerrornodomain"] = "Bitte geben Sie einen gültigen Do";
$_LANG["domainerrortoolong"] = "Die eingegebene Domain ist zu lang. Domains können maximal 67 Zeic";
...
$_LANG["domaingeteppcodeexplanation"] = "Der EPP/Authcode ist kurz gesagt ein Passwort für eine Domain. Dies stellt sicher dass nur der Inhaber der Domain diese auch umziehen kann. Sie benötigen den EPP/Authco";
...
$_LANG["domainintrotext"] = "Geben Sie bitte den zu suchenden Domainnamen an und klicken Sie 'Suchen', um zu prüfen ob die gewü";
...
$_LANG["domainregisternsexplanation"] = "An dieser Stelle können Sie Ihre Nameserver verwalten (eg. NS1.ihredomain.com, NS2.ihredom";
...
$_LANG["domainregistrantchoose"] = "Bitte wählen Sie den zu benutz";
$_LANG["domainregistrantinfo"] = "Domaininhaber";
$_LANG["domainregistrarlock"] = "Registrarsperre";
$_LANG["domainregistrarlockdesc"] = "Registrarsperre aktivieren (empfohlen). Unerlaubte Domainübertragungen / Transfers werden s";
...
$_LANG["domainrenewdesc"] = "Tipp: Sichern Sie sich Ihre Domain gleich für m";
$_LANG["domainsautorenew"] = "";
$_LANG["domainsautorenewdisable"] = "automatische Verlängerung";
$_LANG["domainsautorenewdisabled"] = "Deaktiviert";
$_LANG["domainsautorenewdisabledwarning"] = "Die automatische Verlängerung ist deaktiviert. Sofern die Domain nicht manuell verlängert wird, wird diese am Ende";
$_LANG["domainsautorenewenable"] = "automatische Verlängeru";
...
$_LANG["domainsrenewnow"] = "Erneuern Sie jetzt";
...
$_LANG["downloadloginrequired"] = "Zugriff verweigert! Zum Download müssen Sie ang";
$_LANG["downloadname"] = "Download";
$_LANG["downloadpurchaserequired"] = "Zugriff verweigert! Für den Download müssen Sie d";
...
$_LANG["downloadsintrotext"] = "In der Downloadbibliothek finden Sie Dokumente & Software, die für S";
...
$_LANG["firstpaymentamount"] = "Betrag für die";
...
$_LANG["flashtutorialsheadertext"] = "Unsere Flashtutorials sind hier, um Ihnen bei der Nutzung des Hosting-Controlpanels zu helfen. Wählen Sie eines der unten stehenden Schritt-für-Schritt-Tutorials, um die entsprech";
...
$_LANG["imagecheck"] = "Geben Sie bitte aus Sicherheitsgründen unten stehende";
...
$_LANG["invoiceaddcreditdesc2"] = "Sie können dies über untenstehendes Formular";
$_LANG["invoiceaddcreditoverbalance"] = "Sie können nicht mehr als den geschuldeten Bet";
$_LANG["invoiceaddcreditovercredit"] = "Sie können nicht mehr Guthaben zuweisen,";
$_LANG["invoicenumber"] = "Rechnung";
$_LANG["invoiceofflinepaid"] = "Offline Kreditkartenzahlungen werden manuell ausgeführt. Sie erhalten eine Bestätigung per Email, sobald";
$_LANG["invoicerefnum"] = "Vorgangsnummer";
$_LANG["invoices"] = "Rechnungen";
$_LANG["invoicesamount"] = "Betrag";
$_LANG["invoicesattn"] = "z.H.";
$_LANG["invoicesbacktoclientarea"] = "<< Zurück zum K";
...
$_LANG["invoicesdatedue"] = "Fäll";
$_LANG["invoicesdescription"] = "Beschreibung";
$_LANG["invoicesdownload"] = "Vollständige PDF-Rech";
$_LANG["invoicesdue"] = "Fälli";
...
$_LANG["invoicestransnonefound"] = "Keine zugehörige Transak";
...
$_LANG["kbsuggestionsexplanation"] = "Der folgende Eintrag wurde in der Knowledgebase gefunden und passt vielleicht zur Ihrer Anfrage. Bitte schauen Sie vor dem Öffnen einer Support-Anfrage in die Kn";
...
$_LANG["knowledgebaseintrotext"] = "Die Knowledgebase ist in Kategorien unterteilt. Wählen Sie eine der untenstehenden Kategorien oder durchsuchen Sie die Kn";
...
$_LANG["loginintrotext"] = "Sie müssen sich einloggen um diese Seite anzuzeigen. Die Login-Daten unterscheiden sich von denen Ihrer Serververwaltung oder Ihres";
...
$_LANG["maxmind_anonproxy"] = "Wir erlauben keine Bestellungen über a";
$_LANG["maxmind_callingnow"] = "";
$_LANG["maxmind_countrymismatch"] = "Die IP-Adresse Ihres Landes stimmt nicht mit der IP der Rechnungsadresse überein. Wir können Ihre Bestellung";
$_LANG["maxmind_error"] = "Fehler";
$_LANG["maxmind_faileddescription"] = "Der eingegebene Code ist falsch. Falls es sich dabei um einen Systemfehler handelt, füllen Sie bitte ein Supp";
$_LANG["maxmind_highfraudriskscore"] = "Unser System hat ein hohes Risiko für diese Bestellung ermittelt und den Vorgan";
$_LANG["maxmind_highriskcountry"] = "Wir akzeptieren keine Bestellungen aus Ihrem Land, weil das Risiko fü";
...
$_LANG["orderavailableaddons"] = "Klicken Sie hier um mögliche Zusatzpakete / Option";
...
$_LANG["orderchooseaddons"] = "Wählen Sie Produkt-Zusatzpake";
$_LANG["orderchooseapackage"] = "Paketauswahl";
$_LANG["ordercodenotfound"] = "Der eingegebene Promotion-Code existiert nicht";
$_LANG["ordercompletebutnotpaid"] = "Achtung! Ihre Bestellung wurde abgeschlossen, aber noch nicht bezahlt. Bis zur Bezahlung wird Ihr Auftrag nicht aktiviert. Klicken Sie auf untenstehenden Link für Ihr";
...
$_LANG["orderdomainoption1part2"] = "eine neue Domain für mich zu r";
$_LANG["orderdomainoption2"] = "Ich werde die Nameserver meiner Domain selber ändern lassen oder selber eine neue Domain r";
$_LANG["orderdomainoption3"] = "Ich möchte meine Domain tra";
$_LANG["orderdomainoption4"] = "Ich möchte eine gratis Subdoma";
...
$_LANG["ordererroraccepttos"] = "Sie müssen die allgemeinen Vertragsbedingungen (AGB";
$_LANG["ordererrordomainalreadyexists"] = "";
$_LANG["ordererrordomaininvalid"] = "";
$_LANG["ordererrordomainnotld"] = "Sie müssen eine Domainendung";
$_LANG["ordererrordomainnotregistered"] = "Sie können keine Domain transferieren, die nicht bereits re";
$_LANG["ordererrordomainregistered"] = "Die eingegebene Domain ist bereits registriert";
$_LANG["ordererrornameserver1"] = "Sie müssen Nameser";
$_LANG["ordererrornameserver2"] = "Sie müssen Nameser";
...
$_LANG["ordererrorservernonameservers"] = "Sie müssen einen Prefix für";
$_LANG["ordererrorservernorootpw"] = "Sie müssen das gewünsch";
$_LANG["ordererrorsubdomaintaken"] = "Die Subdomain ist bereits vergeben. Bitte versuchen Sie es erneut.";
$_LANG["ordererrortransfersecret"] = "Sie müssen einen Transferschlüssel (";
...
$_LANG["orderfinalinstructions"] = "Wenn Sie Fragen zu Ihrer Bestellung haben, füllen Sie bitte ein Supportticket im Kudenzentrum aus und fügen Sie bit";
$_LANG["orderfree"] = "Gratis!";
$_LANG["orderfreedomainappliesto"] = "betreffend nur die folgenden Domainendungen (TLD)";
$_LANG["orderfreedomaindescription"] = "zur ausgewählten Zah";
...
$_LANG["ordernotes"] = "Notizen / Zusätzlich";
$_LANG["ordernotesdescription"] = "Hier können Sie zusätzliche Bemerkungen oder Informationen anführen, die Sie zusammen";
...
$_LANG["orderpromoinvalid"] = "Der eingegebene Promotion-Code lässt sich auf keine der Prod";
...
$_LANG["ordersecure"] = "Ihre Daten werden verschlüsselt übertragen. Zu Ihrer Sich";
$_LANG["ordersecure2"] = "gespeichert.";
$_LANG["orderserverhostname"] = "Server Hostname";
$_LANG["orderservernameservers"] = "DNS Nameserver";
$_LANG["orderservernameserversdescription"] = "Die Prefixe die Sie hier eingeben sind die Nameserver für den Server z.B. ns1.ihredomain.com and ns2.ih";
...
$_LANG["ordertaxstaterequired"] = "Sie müssen ein Bundesland zur Berechnung der";
$_LANG["ordertitle"] = "Bestellung";
$_LANG["ordertos"] = "AGB";
$_LANG["ordertosagreement"] = "Ich habe die AGB gelesen und bin damit einverstanden";
$_LANG["ordertotalduetoday"] = "Heute fälliger";
...
$_LANG["ordertransfersecretexplanation"] = "Ein Domain Transfer-Schlüssel (Transfer Secret) muß bei Ihrem aktuellen Domainreg";
...
$_LANG["outofstock"] = "";
$_LANG["outofstockdescription"] = "Dieser Artikel ist gerade nicht verfügbar. Daher kann Ihre Bestellung für diesen Artikel nicht ausgeführt werden. Für weitere Info";
$_LANG["page"] = "Seite";
$_LANG["pageof"] = "von";
$_LANG["please"] = "Bitte";
...
$_LANG["promoexistingclient"] = "Sie müssen ein aktives Produkt / Service haben, um diesen Cod";
$_LANG["promoonceperclient"] = "Dieser Code kann nur einmal pro Kunde verwendet werden";
$_LANG["pwstrengthfail"] = "Das von Ihnen angegebene Passwort ist nicht sicher genug - bitte geben Sie ein höher komplexes";
$_LANG["quicknav"] = "Quick Navigation";
$_LANG["recordsfound"] = "";
$_LANG["recurring"] = "Wiederholend";
$_LANG["recurringamount"] = "";
$_LANG["every"] = "Every";
$_LANG["registerdomain"] = "Domainregistrierung";
$_LANG["registerdomaindesc"] = "Geben Sie bitte den zu suchenden Domainnamen an und klicken Sie 'Suchen' um zu prüfen, ob die gewü";
$_LANG["registerdomainname"] = "Domain registrieren";
$_LANG["relatedservice"] = "Verwandte Services";
$_LANG["rssfeed"] = "Feed";
$_LANG["securityanswerrequired"] = "Sie müssen eine Sicherheitsant";
$_LANG["securitybothnotmatch"] = "Ihre Antwort und Bestätigungsantwort stim";
...
$_LANG["serverchangepasswordfailed"] = "Passwort konnte nicht geä";
...
$_LANG["serverstatusnoservers"] = "Es sind keine Server für die";
...
$_LANG["ssladmininfodetails"] = "Diese Daten werden im Zertifikat nicht angezeigt und werden genutzt, um Sie betreffend der Bereitstellung zu kontaktieren. Das SSL Zertifikat selbst sowie Erneuerungshinweise werden außerdem an diese Adre";
$_LANG["sslcertapproveremail"] = "Bestäti";
$_LANG["sslcertapproveremaildetails"] = "Bitte wählen Sie aus den nachstehenden Kontakten einen für die Zusendu";
...
$_LANG["sslconfigcompletedetails"] = "";
$_LANG["sslconfsslcertificate"] = "SSL Zertifikat konfigurieren";
$_LANG["sslcsr"] = "CSR";
$_LANG["sslerrorapproveremail"] = "";
$_LANG["sslerrorentercsr"] = "Sie müssen den 'Certificate Signing Request' (";
...
$_LANG["supportpresalesquestions"] = "Wünschen Sie Informationen zu unseren Produkten & Dienstleistungen, bevor S";
$_LANG["supportticketinvalid"] = "Ein Fehler ist aufgetreten. Das angeforderte Ticket wurde nicht gefunden. Bitte prüfen Sie d";
...
$_LANG["supportticketsdescription"] = "Hier finden Sie Ihre bereits bestehenden Tickets und können dar";
...
$_LANG["supportticketsheader"] = "Wenn Sie in der Knowledgebase keine Antwort auf Ihr Problem finden können, schicken Sie uns bitte ein Supportticket an die entsprechen";
...
$_LANG["supportticketssystemdescription"] = "Das Supportticketsystem erlaubt uns auf Ihre Probleme und Anfragen möglichst rasch zu reagieren. Wenn wir auf ein Ticket antworten, erhalten Sie zusätzlich";
...
$_LANG["telesigninitiatephone"] = "Wir können die Telefonüberprüfung für Ihr";
$_LANG["telesigninvalidnumber"] = "Ungültige T";
$_LANG["telesigninvalidpin"] = "";
$_LANG["telesigninvalidpin2"] = "";
$_LANG["telesigninvalidpinmessage"] = "PIN-Code Über";
$_LANG["telesignmessage"] = "Telefonüberprüfung für die Num";
$_LANG["telesignphonecall"] = "Telefonanruf";
$_LANG["telesignpin"] = "Geben Sie Ihre PIN ein:";
$_LANG["telesignsms"] = "SMS";
$_LANG["telesignsmstextmessage"] = "Danke, dass Sie unser SMS-Überprüfungssystem verwenden. Ihr Code ist: %s Bitte geben Sie diesen Code";
$_LANG["telesigntitle"] = "";
$_LANG["telesigntype"] = "";
$_LANG["telesignverificationcanceled"] = "Es besteht ein vorübergehendes Problem mit dem Telefonüberprüfungss";
$_LANG["telesignverificationproblem"] = "Es trat ein Problem mit dem Telefonüberprüfungssystem auf und Ihr Auftrag konnte nicht über";
$_LANG["telesignverify"] = "Ihre Telefonnummer %s muss überprüft werden, um d";
$_LANG["ticketratingexcellent"] = "Ausgezeichnet";
$_LANG["ticketratingpoor"] = "Schlecht";
$_LANG["ticketratingquestion"] = "Wie würden Sie diese Antw";
$_LANG["ticketreatinggiven"] = "Sie haben diese Antwort bewertet";
$_LANG["transferdomain"] = "Domaintransfer";
$_LANG["transferdomaindesc"] = "Sie wollen Ihre Domain zu uns umziehen? Bitte geben Sie den Domainnamen ein um die Prüfu";
$_LANG["transferdomainname"] = "Domain zu uns umziehen";
$_LANG["updatecart"] = "Warenkorb aktualisieren";
$_LANG["upgradechooseconfigoptions"] = "Optionen für dieses Paket, die Sie upgraden/dow";
$_LANG["upgradechoosepackage"] = "Wählen Sie das Hosting-Paket, das Sie upgraden/dow";
...
$_LANG["upgradenochange"] = "";
$_LANG["upgradeproductlogic"] = "Der Preis für das Upgrade errechnet sich aus dem noch nicht verwendeten Guthaben des laufenden Paketes und dem Preis für das";
...
$_LANG["varilogixfraudcall_description"] = "Unser Sicherheitssystem wird nun einen Anruf an die von Ihnen angegebene Telefonnummer tätigen und Sie darum bitten, obigen PIN-Code in Ihre Telefontastatur einzugeben. Bitte klicken Sie hier um den Anruf je";
...
$_LANG["pwresetsecurityquestionincorrect"] = "";
$_LANG["pwresetsubmit"] = "Senden";
$_LANG["pwresetvalidationsent"] = "Bestätigungs-Ema";
$_LANG["pwresetvalidationcheckemail"] = "Die Passwortrücksetzung wurde gestartet. Bitte überprü";
$_LANG["pwresetkeyinvalid"] = "Der Rücksetzungslink ist ungülti";
$_LANG["pwresetkeyexpired"] = "Der Rücksetzungslink ist abgelaufen. Bitte erne";
$_LANG["pwresetvalidationsuccess"] = "Passwortrücksetzun";
...
$_LANG["creditcardnostore"] = "Machen sie hier einen Haken wenn Sie NICHT wollen, dass wir ihre Kreditkartendetails für wiederkehrende Rechnung";
...
$_LANG["invoicepaymentfailedconfirmation"] = "Unglücklicherweise ist ihr Bezahlungsversuch fehlgeschlagen.<br />Bitte versuchen Sie es erneut oder kontaktieren si";
...
$_LANG["clientareanoaddons"] = "Keine Zusatzpakete für diesen Acc";
...
$_LANG["serverstatusheadingtext"] = "Die unten stehende Tabelle zeigt den aktuellen Serverstatus. Sie können diese Seite dazu benutzen um nachzusehen, ob einer der Serverdienste aus";
$_LANG["clientareacancelreasonrequired"] = "You must enter a cancellation reason";
$_LANG["addfundsdescription"] = "Sie können Guthaben / Vorauszahlungen zur Zahlung der Rechnungen hinzufügen. Eingezahltes Guthab";
...
$_LANG["opennewticket"] = "Neues Ticket eröf";
$_LANG["searchtickets"] = "Enter Ticket # or Subject";
$_LANG["supportticketspriority"] = "";
$_LANG["supportticketsubmitted"] = "Übertr";
...
$_LANG["upgradedowngradechooseproduct"] = "Produkt auswä";
...
$_LANG["licensingkey"] = "";
$_LANG["licensingvaliddomains"] = "Gültig";
$_LANG["licensingvalidips"] = "Gü";
$_LANG["licensingvaliddirectory"] = "Gültiges Verzei";
...
$_LANG["returnclient"] = "Zurück zum Kund";
