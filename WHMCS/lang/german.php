...
$_LANG["addfunds"] = "Guthaben hinzufüg";
...
$_LANG["affiliatesbullet2"] = "von jeder Zahlung der Kunden, die Sie vermittelt haben. Dies gilt für die gesamte Dauer des Abonn";
$_LANG["affiliatescommission"] = "Kommission";
$_LANG["affiliatesdescription"] = "Klicken Sie hier, um Vermittlungspartner (Affiliate) zu werden, oder um Ihre Einkünfte";
...
$_LANG["affiliatesfootertext"] = "Wenn Sie jemanden mit Ihrer einzigartigen Vermittlungs-ID an unsere Webseite weiterleiten, wird auf diesem Computer ein Cookie mit der Vermittlungs-ID abgelegt. Wenn dieser Besucher später zurückkehrt und eine Dienstleistung bucht erhalten Sie die Kommission";
...
$_LANG["affiliatesrequestwithdrawal"] = "Überweisungs";
...
$_LANG["affiliateswithdrawalrequestsuccessful"] = "Ihr Überweisungsauftrag wurde übermittelt. Sie werden in Kürze";
$_LANG["affiliateswithdrawn"] = "Insgesamt abgehobener Betrag";
$_LANG["all"] = "Alle";
$_LANG["alreadyregistered"] = "Sind Sie bereits Kunde?";
$_LANG["announcementsdescription"] = "Neuigkeiten und Ankündigu";
$_LANG["announcementsnone"] = "Es gibt keine Ankündigu";
$_LANG["announcementsrss"] = "RSS Feed anzeigen";
$_LANG["announcementstitle"] = "Ankündigu";
...
$_LANG["cartcustomfieldsdesc"] = "Für dieses Produkt benötigen wir weitere Informationen zur Ausführung";
$_LANG["cartdomainsconfig"] = "Domainkonfiguration";
$_LANG["cartdomainsconfigdesc"] = "Hier können Sie ihre Domainkonfiguration vornehmen, Erweiterungen hinzufügen und benötigte I";
...
$_LANG["cartnameserversdesc"] = "Wenn Sie eigene Nameserver benutzen möchten geben Sie diese bitte hier an. Standardmäßig stellen wir unsere N";
...
$_LANG["cartproductdesc"] = "Hier sehen Sie die von Ihnen gewählten Produkte und Op";
$_LANG["cartproductdomain"] = "Domains";
$_LANG["cartproductdomainchoose"] = "Domain auswähl";
$_LANG["cartproductdomaindesc"] = "Das von Ihnen gewählte Produkt erfordert die Registrierung eines Domainnamens. Bitte wählen S";
...
$_LANG["carttaxupdateselections"] = "MwSt. wird abhängig vom Land berechnet. Bitte hier zur Neuberechnung k";
...
$_LANG["choosedomains"] = "Domains auswähl";
...
$_LANG["clientareaaddfundsnotallowed"] = "Sie benötigen mindestens eine aktive Bestellung um ein Guthaben hinz";
$_LANG["clientareaaddon"] = "Zusatzpaket";
$_LANG["clientareaaddonorderconfirmation"] = "Vielen Dank. Das untenstehende Zusatzpaket wurde zur Bestellung hinzugefügt. Bitte wählen Sie nun die gewü";
...
$_LANG["clientareacancelconfirmation"] = "Vielen Dank. Der Stornierungsauftrag wurde übermittelt. Falls Sie diesen Auftrag aus Versehen geschickt haben, senden Sie uns bitte umgehend ein Supportticket, bevor wir Ihren Accou";
...
$_LANG["clientareacancelreason"] = "Grund für die Stor";
...
$_LANG["clientareachoosecontact"] = "Kontakt auswähl";
...
$_LANG["clientareacontactsemailsdomain"] = "Domain-Email - Erneuerungshinweise, Registrierungsbestätigun";
...
$_LANG["clientareadeletecontactareyousure"] = "";
$_LANG["clientareadescription"] = "Klicken Sie hier um Ihr Profil zu ändern, Rechnungsinformationen anzuzeigen und zusätzliche Dienstleistung";
...
$_LANG["clientareaemailsintrotext"] = "Unten finden Sie den Verlauf aller Nachrichten, die wir an Sie geschickt haben. Sie können bequem die gesamte Korrespondenz anzeigen, falls Sie unsere Emails nicht mehr zur Ver";
...
$_LANG["clientareaerrorcountry"] = "Bitte wählen Sie Ihr Land aus der Auswa";
$_LANG["clientareaerroremail"] = "Sie haben keine Emailadresse eingegeben";
$_LANG["clientareaerroremailinvalid"] = "Die eingegebene Email Adresse ist NICHT gült";
...
$_LANG["clientareaerroroccured"] = "Es gab einen Fehler, bitte versuchen Sie es später";
$_LANG["clientareaerrorpasswordconfirm"] = "Sie haben Ihr Passwort nicht bestäti";
$_LANG["clientareaerrorpasswordnotmatch"] = "Die Passwortbestätigung ist nicht gleich wie das P";
...
$_LANG["clientareaheader"] = "Willkommen in unserem Kundencenter. Hier können Sie Ihre persönlichen Daten anzeigen und aktualisieren, Ihre Hostingaccounts und Domains anzeigen, Supportanfragen absenden und zusätzliche Produkte & Dienst";
...
$_LANG["clientarealeaveblank"] = "Leer lassen, ausser Sie wollen Ihr Passwort ände";
...
$_LANG["clientareanavaddcontact"] = "Neuen Kontakt hinzufüg";
...
$_LANG["clientareasavechanges"] = "Änderungen sp";
$_LANG["clientareasecurityanswer"] = "Bitte geben Sie eine Antwort ein";
$_LANG["clientareasecurityconfanswer"] = "Bitte bestätigen Sie Ihre";
$_LANG["clientareasecurityquestion"] = "Bitte wählen Sie eine Sicherhei";
$_LANG["clientareaselectcountry"] = "Land auswähl";
...
$_LANG["clientareaviewaddons"] = "Mögliche Zusatzpakete / Optionen a";
$_LANG["clientareaviewdetails"] = "Einzelheiten anzeigen";
$_LANG["clientlogin"] = "Kundenlogin";
$_LANG["clientregisterheadertext"] = "Um ein neues Konto zu eröffnen füllen Sie bitte nachstehendes Formular aus. Die benötigten Felde";
...
$_LANG["closewindow"] = "Fenster schliesen";
...
$_LANG["contactheader"] = "Um uns zu kontaktieren füllen Sie bitte nachstehendes Form";
...
$_LANG["creditcard3dsecure"] = "Als Teil unserer Sicherheitsvorkehrungen gegen Mißbrauch werden Sie nun gebeten, Ihre 'Verified by Visa' oder 'Mastercard SecureCode' Identifikation durchzuführen, sofern Sie für diese Dienste";
...
$_LANG["creditcardconfirmation"] = "Vielen Dank! Ihre Kreditkartenzahlung wurde akzeptiert und Ihre Karte mit dem Betrag belastet. Sie erhalten in Kürze eine Bestäti";
...
$_LANG["creditcardinvalid"] = "Die angegebene Kreditkarte wurde vom Finanzinstitut als ungültig abgewiesen. Bitte versuchen Sie eine andere Kreditkarte oder kontaktieren";
...
$_LANG["domainbulksearchintro"] = "Mit der 'Erweiterten Domainsuche' können Sie bis zu 20 Domains auf einmal abfragen.  Geben Sie in nachstehendes Formular die Domains ein, eine per Zeile, ohne 'www.' oder 'http://' , aber bitte inklusive der Domainendun";
$_LANG["domainbulktransferdescription"] = "Sie können heute noch Ihre bestehenden Domains zu uns transferieren. Um zu beginnen geben Sie bitte die Domains, eine per Zeile, in das folgende Feld ein, ohne 'www.' oder 'ht";
$_LANG["domainbulktransfersearch"] = "Massen-Domaintransfer";
$_LANG["domaincheckerdescription"] = "";
...
$_LANG["domaindnsmanagementdesc"] = "Leiten Sie Ihre Domain auf eine Webseite weiter, indem Sie auf die IP-Adresse verweisen, oder leiten Sie sie auf eine andere Seite weiter, oder leiten Sie sie auf eine temporäre Seite weiter (bekannt als 'Domain Parking'), und mehr. Diese Einträge sind auch bekannt a";
$_LANG["domaindnsrecordtype"] = "Registrierungstyp";
$_LANG["domainemailforwarding"] = "Email-Weiterleitung";
$_LANG["domainemailforwardingdesc"] = "Wenn der weiterleitende Emailserver feststellt, dass die anzusprechende Emailadresse ungültig ist, so werden wir den Weiterleitungseintrag automatisch deaktivieren. Bitte prüfen Sie die Emailadresse, auf die weitergeleitet werden soll, bevor Sie sie wieder aktivieren. Die Änderungen an bestehenden Weiterleitungseinträgen werden nicht in unt";
...
$_LANG["domaineppcodedesc"] = "Wir benötigen zum Providerwechsel einen sogenannten Authcode. Diesen erhalten Sie von Ihrem alten Pr";
$_LANG["domaineppcoderequired"] = "Bitte geben Sie den EPP/Authcode ein.";
$_LANG["domainerror"] = "Bei der Anfrage gab es einen Fehler:";
$_LANG["domainerrornodomain"] = "Bitte geben Sie einen gültigen Domainn";
$_LANG["domainerrortoolong"] = "Die eingegebene Domain ist zu lang. Domains können maximal 67 Zeichen la";
...
$_LANG["domaingeteppcodeexplanation"] = "Der EPP/Authcode ist kurz gesagt ein Passwort für eine Domain. Dies stellt sicher dass nur der Inhaber der Domain diese auch umziehen kann. Sie benötigen den EPP/Authcode zum Prov";
$_LANG["domaingeteppcodefailure"] = "Fehler bei der Anfrage des EPP/Authcode:";
$_LANG["domaingeteppcodeis"] = "EPP/Authcode lautet:";
$_LANG["domainidprotection"] = "Identität";
$_LANG["domainintrotext"] = "Geben Sie bitte den zu suchenden Domainnamen an und klicken Sie 'Suchen', um zu prüfen ob die gewünschte Doma";
...
$_LANG["domainorderrenew"] = "Domain Verlä";
...
$_LANG["domainregisternsexplanation"] = "An dieser Stelle können Sie Ihre Nameserver verwalten (eg. NS1.ihredomain.com, NS2.ihredomain.c";
$_LANG["domainregisternsip"] = "IP-Adresse";
$_LANG["domainregisternsmod"] = "";
$_LANG["domainregisternsmodsuccess"] = "";
...
$_LANG["domainregistrantchoose"] = "Bitte wählen Sie den zu benutzenden";
$_LANG["domainregistrantinfo"] = "Domaininhaber";
$_LANG["domainregistrarlock"] = "Registrarsperre";
$_LANG["domainregistrarlockdesc"] = "Registrarsperre aktivieren (empfohlen). Unerlaubte Domainübertragungen / Transfers werden so verh";
...
$_LANG["domainrenew"] = "";
$_LANG["domainrenewal"] = "Domain Verlä";
$_LANG["domainrenewalprice"] = "Erneuerung";
$_LANG["domainrenewdesc"] = "Tipp: Sichern Sie sich Ihre Domain gleich für mehrer";
$_LANG["domainsautorenew"] = "automatische Verlä";
$_LANG["domainsautorenewdisable"] = "automatische Verlängerung deakt";
$_LANG["domainsautorenewdisabled"] = "Deaktiviert";
$_LANG["domainsautorenewdisabledwarning"] = "Die automatische Verlängerung ist deaktiviert. Sofern die Domain nicht manuell verlängert wird, wird diese am Ende der Laufze";
$_LANG["domainsautorenewenable"] = "automatische Verlängerung akt";
...
$_LANG["downloadloginrequired"] = "Zugriff verweigert! Zum Download müssen Sie angemeld";
$_LANG["downloadname"] = "Download";
$_LANG["downloadpurchaserequired"] = "Zugriff verweigert! Für den Download müssen Sie das dazugehö";
...
$_LANG["downloadsintrotext"] = "In der Downloadbibliothek finden Sie Dokumente & Software, die für Sie nütz";
...
$_LANG["firstpaymentamount"] = "Betrag für die erste";
...
$_LANG["flashtutorialsheadertext"] = "Unsere Flashtutorials sind hier, um Ihnen bei der Nutzung des Hosting-Controlpanels zu helfen. Wählen Sie eines der unten stehenden Schritt-für-Schritt-Tutorials, um die entsprechende Aufga";
...
$_LANG["imagecheck"] = "Geben Sie bitte aus Sicherheitsgründen unten stehende 5 Zeic";
...
$_LANG["invoiceaddcreditdesc2"] = "Sie können dies über untenstehendes Formular einer Rech";
$_LANG["invoiceaddcreditoverbalance"] = "Sie können nicht mehr als den geschuldeten Betrag zu";
$_LANG["invoiceaddcreditovercredit"] = "Sie können nicht mehr Guthaben zuweisen, als Si";
$_LANG["invoicenumber"] = "Rechnung";
$_LANG["invoiceofflinepaid"] = "Offline Kreditkartenzahlungen werden manuell ausgeführt. Sie erhalten eine Bestätigung per Email, sobald die Zahlu";
$_LANG["invoicerefnum"] = "Vorgangsnummer";
$_LANG["invoices"] = "Rechnungen";
$_LANG["invoicesamount"] = "Betrag";
$_LANG["invoicesattn"] = "z.H.";
$_LANG["invoicesbacktoclientarea"] = "<< Zurück zum Kunden";
...
$_LANG["invoicesdatedue"] = "Fälligkei";
$_LANG["invoicesdescription"] = "Beschreibung";
$_LANG["invoicesdownload"] = "Vollständige PDF-Rechnung a";
$_LANG["invoicesdue"] = "Fällige Rec";
...
$_LANG["invoicestransnonefound"] = "Keine zugehörige Transaktion g";
...
$_LANG["kbsuggestionsexplanation"] = "Der folgende Eintrag wurde in der Knowledgebase gefunden und passt vielleicht zur Ihrer Anfrage. Bitte schauen Sie vor dem Öffnen einer Support-Anfrage in die Knowled";
...
$_LANG["knowledgebaseintrotext"] = "Die Knowledgebase ist in Kategorien unterteilt. Wählen Sie eine der untenstehenden Kategorien oder durchsuchen Sie die Knowled";
...
$_LANG["latefee"] = "";
$_LANG["latefeeadded"] = "";
$_LANG["latestannouncements"] = "Letzte Ankünd";
...
$_LANG["loginintrotext"] = "Sie müssen sich einloggen um diese Seite anzuzeigen. Die Login-Daten unterscheiden sich von denen Ihrer Serververwaltung oder Ihres FTP-Z";
...
$_LANG["maxmind_anonproxy"] = "Wir erlauben keine Bestellungen über anonym";
$_LANG["maxmind_callingnow"] = "";
$_LANG["maxmind_countrymismatch"] = "Die IP-Adresse Ihres Landes stimmt nicht mit der IP der Rechnungsadresse überein. Wir können Ihre Bestellung leider nic";
$_LANG["maxmind_error"] = "Fehler";
$_LANG["maxmind_faileddescription"] = "Der eingegebene Code ist falsch. Falls es sich dabei um einen Systemfehler handelt, füllen Sie bitte ein Supportti";
$_LANG["maxmind_highfraudriskscore"] = "Unser System hat ein hohes Risiko für diese Bestellung ermittelt und den Vorgang abge";
$_LANG["maxmind_highriskcountry"] = "Wir akzeptieren keine Bestellungen aus Ihrem Land, weil das Risiko für Mißbr";
...
$_LANG["orderchooseaddons"] = "Wählen Sie Produkt-Zusatzpakete / -O";
$_LANG["orderchooseapackage"] = "Paketauswahl";
$_LANG["ordercodenotfound"] = "Der eingegebene Promotion-Code existiert nicht";
$_LANG["ordercompletebutnotpaid"] = "Achtung! Ihre Bestellung wurde abgeschlossen, aber noch nicht bezahlt. Bis zur Bezahlung wird Ihr Auftrag nicht aktiviert. Klicken Sie auf untenstehenden Link für Ihre Rech";
...
$_LANG["orderdomainoption1part2"] = "eine neue Domain für mich zu regist";
$_LANG["orderdomainoption2"] = "Ich werde die Nameserver meiner Domain selber ändern lassen oder selber eine neue Domain regist";
$_LANG["orderdomainoption3"] = "Ich möchte meine Domain transfer";
$_LANG["orderdomainoption4"] = "Ich möchte eine gratis Subdomain ver";
...
$_LANG["ordererroraccepttos"] = "Sie müssen die allgemeinen Vertragsbedingungen (AGB) akze";
$_LANG["ordererrordomainalreadyexists"] = "";
$_LANG["ordererrordomaininvalid"] = "";
$_LANG["ordererrordomainnotld"] = "Sie müssen eine Domainendung (TLD)";
$_LANG["ordererrordomainnotregistered"] = "Sie können keine Domain transferieren, die nicht bereits registr";
$_LANG["ordererrordomainregistered"] = "Die eingegebene Domain ist bereits registriert";
$_LANG["ordererrornameserver1"] = "Sie müssen Nameserver 1 e";
$_LANG["ordererrornameserver2"] = "Sie müssen Nameserver 2 e";
...
$_LANG["ordererrorservernohostname"] = "Sie müssen einen Hostnamen für Ihren";
$_LANG["ordererrorservernonameservers"] = "Sie müssen einen Prefix für beide Name";
$_LANG["ordererrorservernorootpw"] = "Sie müssen das gewünschte Root-Pa";
$_LANG["ordererrorsubdomaintaken"] = "Die Subdomain ist bereits vergeben. Bitte versuchen Sie es erneut.";
$_LANG["ordererrortransfersecret"] = "Sie müssen einen Transferschlüssel (Transfer S";
...
$_LANG["orderfinalinstructions"] = "Wenn Sie Fragen zu Ihrer Bestellung haben, füllen Sie bitte ein Supportticket im Kudenzentrum aus und fügen Sie bitte Ihre Bes";
$_LANG["orderfree"] = "Gratis!";
$_LANG["orderfreedomainappliesto"] = "betreffend nur die folgenden Domainendungen (TLD)";
$_LANG["orderfreedomaindescription"] = "zur ausgewählten Zahlungs";
...
$_LANG["ordernotes"] = "Notizen / Zusätzliche Info";
$_LANG["ordernotesdescription"] = "Hier können Sie zusätzliche Bemerkungen oder Informationen anführen, die Sie zusammen mit Ihrer Bestel";
...
$_LANG["orderpromoinvalid"] = "Der eingegebene Promotion-Code lässt sich auf keine der Produkte a";
...
$_LANG["orderreceived"] = "Vielen Dank für die Bestellung. Sie erhalten in Kürze eine B";
$_LANG["orderregisterdomain"] = "eine neue Domain registrieren";
$_LANG["orderregperiod"] = "Registrierungsperiode";
$_LANG["ordersecure"] = "Ihre Daten werden verschlüsselt übertragen. Zu Ihrer Sicherheit wird";
$_LANG["ordersecure2"] = "gespeichert.";
$_LANG["orderserverhostname"] = "Server Hostname";
$_LANG["orderservernameservers"] = "DNS Nameserver";
$_LANG["orderservernameserversdescription"] = "Die Prefixe die Sie hier eingeben sind die Nameserver für den Server z.B. ns1.ihredomain.com and ns2.ihredom";
...
$_LANG["ordertaxstaterequired"] = "Sie müssen ein Bundesland zur Berechnung der MwSt.";
$_LANG["ordertitle"] = "Bestellung";
$_LANG["ordertos"] = "AGB";
$_LANG["ordertosagreement"] = "Ich habe die AGB gelesen und bin damit einverstanden";
$_LANG["ordertotalduetoday"] = "Heute fälliger Gesam";
...
$_LANG["ordertransfersecretexplanation"] = "Ein Domain Transfer-Schlüssel (Transfer Secret) muß bei Ihrem aktuellen Domainregistrar bea";
...
$_LANG["outofstock"] = "";
$_LANG["outofstockdescription"] = "Dieser Artikel ist gerade nicht verfügbar. Daher kann Ihre Bestellung für diesen Artikel nicht ausgeführt werden. Für weitere Informationen wenden Sie";
$_LANG["page"] = "Seite";
$_LANG["pageof"] = "von";
$_LANG["please"] = "Bitte";
...
$_LANG["promoexistingclient"] = "Sie müssen ein aktives Produkt / Service haben, um diesen Code zu ve";
$_LANG["promoonceperclient"] = "Dieser Code kann nur einmal pro Kunde verwendet werden";
$_LANG["pwstrengthfail"] = "Das von Ihnen angegebene Passwort ist nicht sicher genug - bitte geben Sie ein höher komplexes Passw";
$_LANG["quicknav"] = "Quick Navigation";
$_LANG["recordsfound"] = "Datensätze g";
$_LANG["recurring"] = "Wiederholend";
$_LANG["recurringamount"] = "Betrag für die Verlän";
$_LANG["every"] = "Every";
$_LANG["registerdomain"] = "Domainregistrierung";
$_LANG["registerdomaindesc"] = "Geben Sie bitte den zu suchenden Domainnamen an und klicken Sie 'Suchen' um zu prüfen, ob die gewünschte Doma";
$_LANG["registerdomainname"] = "Domain registrieren";
$_LANG["relatedservice"] = "Verwandte Services";
$_LANG["rssfeed"] = "Feed";
$_LANG["securityanswerrequired"] = "Sie müssen eine Sicherheitsantwort e";
$_LANG["securitybothnotmatch"] = "Ihre Antwort und Bestätigungsantwort stimmen ni";
...
$_LANG["serverchangepasswordfailed"] = "Passwort konnte nicht geändert";
$_LANG["serverchangepasswordsuccessful"] = "";
...
$_LANG["serverstatusnoservers"] = "Es sind keine Server für die Überwachu";
...
$_LANG["ssladmininfodetails"] = "Diese Daten werden im Zertifikat nicht angezeigt und werden genutzt, um Sie betreffend der Bereitstellung zu kontaktieren. Das SSL Zertifikat selbst sowie Erneuerungshinweise werden außerdem an diese Adresse ve";
$_LANG["sslcertapproveremail"] = "Bestätigungs";
$_LANG["sslcertapproveremaildetails"] = "Bitte wählen Sie aus den nachstehenden Kontakten einen für die Zusendung der Bes";
...
$_LANG["sslconfigcompletedetails"] = "Die Konfiguration ist nun vollständig und wird an den Aussteller (CA) zur Prüfung übergeben. Sie sollten in Kürze eine";
$_LANG["sslconfsslcertificate"] = "SSL Zertifikat konfigurieren";
$_LANG["sslcsr"] = "CSR";
$_LANG["sslerrorapproveremail"] = "Bitten wählen Sie eine Emailadresse für";
$_LANG["sslerrorentercsr"] = "Sie müssen den 'Certificate Signing Request' (CSR) a";
...
$_LANG["supportpresalesquestions"] = "Wünschen Sie Informationen zu unseren Produkten & Dienstleistungen, bevor Sie bes";
$_LANG["supportticketinvalid"] = "Ein Fehler ist aufgetreten. Das angeforderte Ticket wurde nicht gefunden. Bitte prüfen Sie die Tic";
...
$_LANG["supportticketsdescription"] = "Hier finden Sie Ihre bereits bestehenden Tickets und können darauf an";
...
$_LANG["supportticketsheader"] = "Wenn Sie in der Knowledgebase keine Antwort auf Ihr Problem finden können, schicken Sie uns bitte ein Supportticket an die entsprechende Abt";
...
$_LANG["supportticketssystemdescription"] = "Das Supportticketsystem erlaubt uns auf Ihre Probleme und Anfragen möglichst rasch zu reagieren. Wenn wir auf ein Ticket antworten, erhalten Sie zusätzlich eine Nachr";
...
$_LANG["telesigninitiatephone"] = "Wir können die Telefonüberprüfung für Ihre Nummer nicht durchf";
$_LANG["telesigninvalidnumber"] = "Ungültige Telefo";
$_LANG["telesigninvalidpin"] = "";
$_LANG["telesigninvalidpin2"] = "";
$_LANG["telesigninvalidpinmessage"] = "PIN-Code Überprüfung";
$_LANG["telesignmessage"] = "Telefonüberprüfung für die Nummer %s ist gest";
$_LANG["telesignphonecall"] = "Telefonanruf";
$_LANG["telesignpin"] = "Geben Sie Ihre PIN ein:";
$_LANG["telesignsms"] = "SMS";
$_LANG["telesignsmstextmessage"] = "Danke, dass Sie unser SMS-Überprüfungssystem verwenden. Ihr Code ist: %s Bitte geben Sie diesen Code nun an Ihr";
$_LANG["telesigntitle"] = "";
$_LANG["telesigntype"] = "Wählen Sie den Überprüfu";
$_LANG["telesignverificationcanceled"] = "Es besteht ein vorübergehendes Problem mit dem Telefonüberprüfungssystem, die Telefo";
$_LANG["telesignverificationproblem"] = "Es trat ein Problem mit dem Telefonüberprüfungssystem auf und Ihr Auftrag konnte nicht überprüft werden. Bitte";
$_LANG["telesignverify"] = "Ihre Telefonnummer %s muss überprüft werden, um den Auftrag";
$_LANG["ticketratingexcellent"] = "Ausgezeichnet";
$_LANG["ticketratingpoor"] = "Schlecht";
$_LANG["ticketratingquestion"] = "Wie würden Sie diese Antwort be";
$_LANG["ticketreatinggiven"] = "Sie haben diese Antwort bewertet";
$_LANG["transferdomain"] = "Domaintransfer";
$_LANG["transferdomaindesc"] = "Sie wollen Ihre Domain zu uns umziehen? Bitte geben Sie den Domainnamen ein um die Prüfung zu s";
$_LANG["transferdomainname"] = "Domain zu uns umziehen";
$_LANG["updatecart"] = "Warenkorb aktualisieren";
$_LANG["upgradechooseconfigoptions"] = "Optionen für dieses Paket, die Sie upgraden/downgrad";
$_LANG["upgradechoosepackage"] = "Wählen Sie das Hosting-Paket, das Sie upgraden/downgrad";
...
$_LANG["upgradenochange"] = "Keine Änd";
$_LANG["upgradeproductlogic"] = "Der Preis für das Upgrade errechnet sich aus dem noch nicht verwendeten Guthaben des laufenden Paketes und dem Preis für das neue Paket";
...
$_LANG["varilogixfraudcall_description"] = "Unser Sicherheitssystem wird nun einen Anruf an die von Ihnen angegebene Telefonnummer tätigen und Sie darum bitten, obigen PIN-Code in Ihre Telefontastatur einzugeben. Bitte klicken Sie hier um den Anruf jetzt au";
...
$_LANG["pwresetsecurityquestionincorrect"] = "Die eingegebene Geheimfrage stimmt nicht mit der auf Ihrem Account festgelegten ü";
$_LANG["pwresetsubmit"] = "Senden";
$_LANG["pwresetvalidationsent"] = "Bestätigungs-Email ver";
$_LANG["pwresetvalidationcheckemail"] = "Die Passwortrücksetzung wurde gestartet. Bitte überprüfen Sie ihre Ema";
$_LANG["pwresetkeyinvalid"] = "Der Rücksetzungslink ist ungültig. Bitte er";
$_LANG["pwresetkeyexpired"] = "Der Rücksetzungslink ist abgelaufen. Bitte erneut ver";
$_LANG["pwresetvalidationsuccess"] = "Passwortrücksetzung erfo";
...
$_LANG["creditcardnostore"] = "Machen sie hier einen Haken wenn Sie NICHT wollen, dass wir ihre Kreditkartendetails für wiederkehrende Rechnungen ver";
$_LANG["creditcarddelete"] = "";
...
$_LANG["invoicepaymentfailedconfirmation"] = "Unglücklicherweise ist ihr Bezahlungsversuch fehlgeschlagen.<br />Bitte versuchen Sie es erneut oder kontaktieren sie den S";
...
$_LANG["clientareanoaddons"] = "Keine Zusatzpakete für diesen Account g";
...
$_LANG["serverstatusheadingtext"] = "Die unten stehende Tabelle zeigt den aktuellen Serverstatus. Sie können diese Seite dazu benutzen um nachzusehen, ob einer der Serverdienste ausgefal";
$_LANG["clientareacancelreasonrequired"] = "You must enter a cancellation reason";
$_LANG["addfundsdescription"] = "Sie können Guthaben / Vorauszahlungen zur Zahlung der Rechnungen hinzufügen. Eingezahltes Guthaben ist nic";
...
$_LANG["manage"] = "Manage";
$_LANG["quoteacceptancetitle"] = "";
$_LANG["quoteacceptancehowto"] = "";
$_LANG["quoteacceptancewarning"] = "";
$_LANG["passwordstrength"] = "";
$_LANG["strong"] = "Stark";
$_LANG["moderate"] = "";
$_LANG["weak"] = "";
$_LANG["contactform"] = "";
$_LANG["twoipverificationstep"] = "";
$_LANG["twoipverificationstepmsg"] = "";
$_LANG["twoipverificationerror"] = "";
$_LANG["twoipcodemissmatch"] = "";
$_LANG["twoiptimebasedpassword"] = "";
$_LANG["twoiptimebasedexplain"] = "";
$_LANG["twoipconfigureapp"] = "";
$_LANG["twoipconfigurestep1"] = "";
$_LANG["twoipconfigurestep2"] = "";
$_LANG["twoipgdmissing"] = "";
$_LANG["domaincontactdetails']['First Name"] = "";
$_LANG["domaincontactdetails']['Last Name"] = "";
$_LANG["domaincontactdetails']['Full Name"] = "";
$_LANG["domaincontactdetails']['Contact Name"] = "";
$_LANG["domaincontactdetails']['Email"] = "";
$_LANG["domaincontactdetails']['Email Address"] = "";
$_LANG["domaincontactdetails']['Job Title"] = "";
$_LANG["domaincontactdetails']['Company Name"] = "";
$_LANG["domaincontactdetails']['Organisation Name"] = "";
$_LANG["domaincontactdetails']['Address"] = "";
$_LANG["domaincontactdetails']['Street"] = "";
$_LANG["domaincontactdetails']['Address 1"] = "";
$_LANG["domaincontactdetails']['Address 2"] = "";
$_LANG["domaincontactdetails']['Address 3"] = "";
$_LANG["domaincontactdetails']['City"] = "";
$_LANG["domaincontactdetails']['State"] = "";
$_LANG["domaincontactdetails']['County"] = "";
$_LANG["domaincontactdetails']['Region"] = "";
$_LANG["domaincontactdetails']['Postcode"] = "";
$_LANG["domaincontactdetails']['ZIP Code"] = "";
$_LANG["domaincontactdetails']['ZIP"] = "";
$_LANG["domaincontactdetails']['Country"] = "";
$_LANG["domaincontactdetails']['Phone"] = "";
$_LANG["domaincontactdetails']['Phone Number"] = "";
$_LANG["domaincontactdetails']['Fax"] = "";
$_LANG["serverhostnameexample"] = "z.b. server1(.yourdomain.com)";
$_LANG["serverns1prefixexample"] = "z.b. ns1(.yourdomain.com)";
$_LANG["serverns2prefixexample"] = "z.b. ns2(.yourdomain.com)";
$_LANG["hosting"] = "";
